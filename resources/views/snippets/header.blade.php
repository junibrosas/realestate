    	...
    	<div class="row header-row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12  pull-right">
                <div class="social clearfix pull-right">
                    ...
                    <span><a data-placement="bottom" data-toggle="tooltip" data-original-title="Pinterest" title="" href="#"><i class="fa fa-pinterest"></i></a></span>                </div><!-- end social -->
            </div>     
        </div><!-- end row -->
            ...
            <div class="menudrop container">
                ...
                <div id="defaultmenu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown fhmm-fw active"><a href="{{ route('front.home') }}"><i class="fa fa-home"></i> HOME</a></li><!-- mega menu -->
...
@if(!in_array(\Request::route()->getName(), ['front.home']))
